...
public class IntSequenceExactlyOnceValidator extends RichSinkFunction<Integer>
	...
	public void invoke(Integer value) throws Exception {
		...
		if (numElementsSoFar == numElementsTotal) {
			log.info("Maximum Event Size Reached... Wait for couple more checkpoints to complete for Pravega to commit the transaction");
		}
	}
	...
	public static class SuccessException extends SuppressRestartsException {
