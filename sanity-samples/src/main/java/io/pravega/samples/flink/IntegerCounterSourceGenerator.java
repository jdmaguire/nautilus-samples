 ...
 */
public class IntegerCounterSourceGenerator
	...
	public IntegerCounterSourceGenerator(final int numEventsTotal) {
		this(numEventsTotal, numEventsTotal / 2);
	}

	public IntegerCounterSourceGenerator(final int numEventsTotal, final int latestPosForCheckpoint) {
